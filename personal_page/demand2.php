	...
	<body>
      ...
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf">
          <strong class="am-text-primary am-text-lg">代行募集</strong>
        </div>
      </div>
				...
				?>
					<li>
						<a href="javascript:void(0)" onclick="updatePwd('お求め物',5,'./demand_content.php?ra_id=<?php echo $row[$i]['ra_id']; ?>')">
							...
							<div class="ra_name">
		            <p>お求め物:<?php echo $row[$i]['ra_name']; ?></p>
		          </div>
		          <div class="ra_price">
		            <p>お求め価格:<?php echo $row[$i]['ra_price']; ?></p>
		          </div>
		          <div class="bid_price">
		            <p><?php if($row_bidprice==null){
		              echo "まだ誰も入札してくれなかった";
		            }
		            elseif($row_bidprice[$i]['MIN(bid_price)']){
